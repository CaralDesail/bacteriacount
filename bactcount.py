...
image = 'ecoli.jpg' #nom de l'image du dossier courant/name of current file
margecrop0=10 #crop avant et après dans l'axeO /how many pixels to crop on 0 axis
margecrop1=10 #crop avant et après dans l'axe1 / how many pixels to crop on 1 axis
seuil=190 #quel seuil de détection des bactéries/rapport au fond / level of detection of bacterias
...
# bottom level for the validation of the bacteria existence according it's size
